...
\usepackage{amsmath,mathtools} % Paquetes matemáticos
...
\bibliography{referencias} % El nombre de tu archivo .bib
...
\usepackage{fancyhdr}
\pagestyle{fancy}
\fancyhead{} % Limpia todos los encabezados
\fancyfoot{} % Limpia todos los pies de página
